...
public class PlayersFragmentTwoViewModel  extends AndroidViewModel implements OperationCallBack {
    ...
    public PlayersFragmentTwoViewModel(@NonNull Application application) {
        super(application);
        // set default value
